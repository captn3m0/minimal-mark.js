...
return t.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g,"\\$&")}createMergedBlanksRegExp(t){return t.replace(/[\s]+/gim,"[\\s]+")}createAccuracyRegExp(t){let e=this.opt.accuracy,s=("string"==typeof e||e.value,"string"==typeof e?[]:e.limiters),r="";return s.forEach(t=>{r+=`|${this.escapeStr(t)}`}),`(^|\\s${r})(${t})(?=$|\\s${r})`}}
/**
