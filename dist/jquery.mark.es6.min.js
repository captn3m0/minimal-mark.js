...
*****************************************************/
!function(t,e){"object"==typeof exports&&"undefined"!=typeof module?module.exports=e(require("jquery")):"function"==typeof define&&define.amd?define(["jquery"],e):t.Mark=e(t.jQuery)}(this,function(t){"use strict";class e{constructor(t){
/**
...
/**
     ...
     * @access protected
     */iterateThroughNodes(t,e,s,r,n){const o=this.createIterator(e,t,r);let i,a,h=[],l=()=>(({prevNode:a,node:i}=this.getIteratorNode(o)),i);for(;l();)
// it's faster to call the each callback in an array loop
// than in this while loop
h.push(i);h.forEach(t=>{s(t)}),n()}
/**
...
/**
     ...
     * @access public
     */forEachNode(t,e,s,r=(()=>{})){const n=this.getContexts();let o=n.length;o||r(),n.forEach(n=>{
// wait for iframes to avoid recursive calls, otherwise this would
// perhaps reach the recursive function call limit with many nodes
(()=>{this.iterateThroughNodes(t,n,e,s,()=>{--o<=0&&// call end all contexts were handled
r()})})()})}
/**
...
/**
     ...
     * @type {number}
     */}class s{constructor(t){this.opt=Object.assign({},{
// 'diacritics': false,
// 'synonyms': {},
// 'accuracy': 'exactly',
...
if(!Array.isArray(t)||"[object Object]"!==Object.prototype.toString.call(t[0]))return this.log("markRanges() will only accept an array of objects"),this.opt.noMatch(t),[];const e=[];let s=0;return t.sort((t,e)=>t.start-e.start).forEach(t=>{let{start:r,end:n,valid:o}=this.callNoMatchOnInvalidRanges(t,s);o&&(
// preserve item in case there are extra key:values within
t.start=r,t.length=n-r,e.push(t),s=n)}),e}
/**
...
/**
     ...
     * @access protected
     */callNoMatchOnInvalidRanges(t,e){let s,r,n=!1;return t&&void 0!==t.start?(r=(s=parseInt(t.start,10))+parseInt(t.length,10),
// ignore overlapping values & non-numeric entries
this.isNumeric(t.start)&&this.isNumeric(t.length)&&r-e>0&&r-s>0?n=!0:(this.log("Ignoring invalid or overlapping range: "+`${JSON.stringify(t)}`),this.opt.noMatch(t))):(this.log(`Ignoring invalid range: ${JSON.stringify(t)}`),this.opt.noMatch(t)),{start:s,end:r,valid:n}}
/**
     ...
     * @return {Mark~validObject}
     * @access protected
     */checkWhitespaceRanges(t,e,s){let r,n=!0,
// the max value changes after the DOM is manipulated
o=s.length,
// adjust offset to account for wrapped text node
i=e-o,a=parseInt(t.start,10)-i;
// make sure to stop at max
return(r=(a=a>o?o:a)+parseInt(t.length,10))>o&&(r=o,this.log(`End range automatically set to the max value of ${o}`)),a<0||r-a<0||a>o||r>o?(n=!1,this.log(`Invalid range: ${JSON.stringify(t)}`),this.opt.noMatch(t)):""===s.substring(a,r).replace(/\s+/g,"")&&(n=!1,
// whitespace only; even if wrapped it is not visible
this.log("Skipping whitespace only range: "+JSON.stringify(t)),this.opt.noMatch(t)),{start:a,end:r,valid:n}}
/**
...
/**
     ...
     * @return {boolean}
     * @access protected
     */matchesExclude(t){return e.matches(t,this.opt.exclude.concat([
...
/**
     ...
     * @access protected
     */wrapRangeInTextNode(t,e,s){const r=this.opt.element?this.opt.element:"mark",n=t.splitText(e),o=n.splitText(s-e);let i=document.createElement(r);return i.setAttribute("data-markjs","true"),this.opt.className&&i.setAttribute("class",this.opt.className),i.textContent=n.textContent,n.parentNode.replaceChild(i,n),o}
/**
...
/**
     ...
     * @access protected
     */wrapRangeInMappedTextNode(t,e,s,r,n){
// iterate over all text nodes to find the one matching the positions
t.nodes.every((o,i)=>{const a=t.nodes[i+1];if(void 0===a||a.start>e){if(!r(o.node))return!1;
// map range from dict.value to text node
const a=e-o.start,h=(s>o.end?o.end:s)-o.start,l=t.value.substr(0,o.start),c=t.value.substr(h+o.start);if(o.node=this.wrapRangeInTextNode(o.node,a,h),
// recalculate positions to also find subsequent matches in the
// same text node. Necessary as the text node in dict now only
// contains the splitted part after the wrapped one
t.value=l+c,t.nodes.forEach((e,s)=>{s>=i&&(t.nodes[s].start>0&&s!==i&&(t.nodes[s].start-=h),t.nodes[s].end-=h)}),s-=h,n(o.node.previousSibling,o.start),!(s>o.end))return!1;e=o.end}return!0})}
/**
...
/**
     ...
     * @param {Mark~wrapMatchesEachCallback} eachCb
     */separateGroups(t,e,s,r,n){let o=e.length;for(let s=1;s<o;s++){let o=t.textContent.indexOf(e[s]);e[s]&&o>-1&&r(e[s],t)&&(t=this.wrapGroups(t,o,e[s].length,n))}return t}
/**
...
/**
     ...
     * @access protected
     */wrapMatches(t,e,s,r,n){const o=0===e?0:e+1;this.getTextNodes(e=>{e.nodes.forEach(e=>{let n;for(e=e.node;null!==(n=t.exec(e.textContent))&&""!==n[o];){if(this.opt.separateGroups&&1!==n.length)e=this.separateGroups(e,n,o,s,r);else{if(!s(n[o],e))continue;let t=n.index;if(0!==o)for(let e=1;e<o;e++)t+=n[e].length;e=this.wrapGroups(e,t,n[o].length,r)}
...
/**
     ...
     * @access protected
     */wrapMatchesAcrossElements(t,e,s,r,n){const o=0===e?0:e+1;this.getTextNodes(e=>{let i;for(;null!==(i=t.exec(e.value))&&""!==i[o];){
// calculate range inside dict.value
let n=i.index;if(0!==o)for(let t=1;t<o;t++)n+=i[t].length;const a=n+i[o].length;
// note that dict will be updated automatically, as it'll change
// in the wrapping process, due to the fact that text
// nodes will be splitted
this.wrapRangeInMappedTextNode(e,n,a,t=>s(i[o],t),(e,s)=>{t.lastIndex=s,r(e)})}n()})}
/**
     * Callback for each wrapped element
...
/**
     ...
     * @access protected
     */wrapRangeFromIndex(t,e,s,r){this.getTextNodes(n=>{const o=n.value.length;t.forEach((t,r)=>{let{start:i,end:a,valid:h}=this.checkWhitespaceRanges(t,o,n.value);h&&this.wrapRangeInMappedTextNode(n,i,a,s=>e(s,t,n.value.substring(i,a),r),e=>{s(e,t)})}),r()})}
/**
...
/**
     ...
     * @access public
     */mark(t,e){this.opt=e;let r=0,n="wrapMatches";const{keywords:o,length:i}=this.getSeparatedKeywords("string"==typeof t?[t]:t),a=t=>{// async function calls as iframes are async too
const e=new s(this.opt).create(t);let h=0;this.log(`Searching with expression "${e}"`),this[n](e,1,(e,s)=>this.opt.filter(s,t,r,h),t=>{h++,r++,this.opt.each(t)},()=>{0===h&&this.opt.noMatch(t),o[i-1]===t?this.opt.done(r):a(o[o.indexOf(t)+1])})};this.opt.acrossElements&&(n="wrapMatchesAcrossElements"),0===i?this.opt.done(r):a(o[0])}
/**
     * Callback for each marked element
...
/**
     ...
     * @access public
     */unmark(t){this.opt=t;let s=this.opt.element?this.opt.element:"*";s+="[data-markjs]",this.opt.className&&(s+=`.${this.opt.className}`),this.log(`Removal selector "${s}"`),this.iterator.forEachNode(NodeFilter.SHOW_ELEMENT,t=>{this.unwrapMatches(t)},t=>{const r=e.matches(t,s),n=this.matchesExclude(t);return!r||n?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT},this.opt.done)}}return(t=t&&t.hasOwnProperty("default")?t.default:t).fn.mark=function(t,e){return new r(this.get()).mark(t,e),this},t.fn.markRegExp=function(t,e){return new r(this.get()).markRegExp(t,e),this},t.fn.markRanges=function(t,e){return new r(this.get()).markRanges(t,e),this},t.fn.unmark=function(t){return new r(this.get()).unmark(t),this},t});
